...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from lab06.y  */
...
const int YY_parser_CLASS::INTEGER=259;
const int YY_parser_CLASS::REALNUM=260;
const int YY_parser_CLASS::FLOAT=261;
const int YY_parser_CLASS::INT=262;
const int YY_parser_CLASS::LCURLY=263;
const int YY_parser_CLASS::RCURLY=264;
const int YY_parser_CLASS::SEMI=265;
const int YY_parser_CLASS::PLUS=266;
const int YY_parser_CLASS::ASSIGN=267;
const int YY_parser_CLASS::LPAREN=268;
const int YY_parser_CLASS::RPAREN=269;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 270 ? yytranslate[x] : 26)
...
static const short yyprhs[] = {     0,
     0,     1,     6,     8,    12,    15,    17,    19,    21,    23,
    25,    28,    32,    34,    36,    40,    42,    44,    46,    48,
    50
};

static const short yyrhs[] = {    -1,
     8,    18,    17,     9,     0,     1,     0,    18,    19,    10,
     0,    19,    10,     0,     1,     0,    21,     0,    20,     0,
    22,     0,     1,     0,    24,     3,     0,    21,    11,    23,
     0,    23,     0,     1,     0,     3,    12,    21,     0,    25,
     0,     3,     0,     7,     0,     6,     0,     4,     0,     5,
     0
};
...
static const short yyrline[] = { 0,
    54,    55,    55,    58,    59,    60,    63,    64,    65,    66,
    69,    75,    82,    83,    86,    94,    96,    99,   100,   103,
   104
};

static const char * const yytname[] = {   "$","error","$illegal.","IDENT","INTEGER",
"REALNUM","FLOAT","INT","LCURLY","RCURLY","SEMI","PLUS","ASSIGN","LPAREN","RPAREN",
"ERROR","block","@1","stmt_seq","stmt","decl","expr","assignmnt","term","decltype",
"number",""
};
#endif

static const short yyr1[] = {     0,
    17,    16,    16,    18,    18,    18,    19,    19,    19,    19,
...
static const short yydefact[] = {     0,
     3,     0,     6,    17,    20,    21,    19,    18,     0,     0,
     8,     7,     9,    13,     0,    16,     0,    10,     0,     0,
     5,     0,    11,    14,    17,    15,     2,     4,    12,     0,
     0,     0
};
...
-32768,    12,    15,   -11,-32768,-32768,-32768,-32768,    -1,    11,
-32768,    -2,-32768,-32768,    24,-32768,    19,    17,    20,    21,
-32768,     7,-32768,-32768,-32768,    -2,-32768,-32768,-32768,    30,
    32,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,    25,-32768,    16,-32768,    13,-32768,-32768
};
...
static const short yytable[] = {    18,
    17,     4,     5,     6,     7,     8,     1,    -1,    22,    25,
     5,     6,     3,     2,     4,     5,     6,     7,     8,    24,
    21,    25,     5,     6,   -10,   -14,    23,   -14,    27,    31,
    28,    32,    26,    20,    29
};

static const short yycheck[] = {     1,
    12,     3,     4,     5,     6,     7,     1,     9,    11,     3,
     4,     5,     1,     8,     3,     4,     5,     6,     7,     1,
    10,     3,     4,     5,    10,    11,     3,    11,     9,     0,
    10,     0,    17,     9,    22
};
...
{ 
               ...
               if  (yyvsp[-2].toktype != yyvsp[0].toktype) {
...
#line 86 "lab06.y"
{ 
                if (lookupType(yyvsp[-2].name) != yyvsp[0].toktype)  {
