...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from lab07.y  */
...
const int YY_parser_CLASS::PLUS=261;
const int YY_parser_CLASS::LCURLY=262;
const int YY_parser_CLASS::RCURLY=263;
const int YY_parser_CLASS::LPAREN=264;
const int YY_parser_CLASS::RPAREN=265;
const int YY_parser_CLASS::SEMI=266;
const int YY_parser_CLASS::ERROR=267;
const int YY_parser_CLASS::FLOAT=268;
const int YY_parser_CLASS::INT=269;
...
static const short yyprhs[] = {     0,
     0,     3,     4,     7,    11,    13,    17,    20,    22,    24,
    26,    28,    32,    36,    38,    40,    44,    46,    48,    50
};

static const short yyrhs[] = {    16,
    17,     0,     0,    16,    20,     0,     7,    18,     8,     0,
     1,     0,    18,    19,    11,     0,    19,    11,     0,     1,
     0,    21,     0,    22,     0,     1,     0,    24,     3,    11,
     0,    21,     6,    23,     0,    23,     0,     1,     0,     3,
     5,    21,     0,     4,     0,     3,     0,    14,     0,    13,
     0
};
...
static const short yyrline[] = { 0,
    53,    55,    56,    58,    59,    62,    63,    64,    67,    68,
    69,    72,    82,    84,    85,    88,    96,    98,   101,   102
};

static const char * const yytname[] = {   "$","error","$illegal.","IDENT","NUMBER",
"ASSIGN","PLUS","LCURLY","RCURLY","LPAREN","RPAREN","SEMI","ERROR","FLOAT","INT",
"prog","decl_seq","block","stmt_seq","stmt","decl","expr","assignmnt","term",
"decltype",""
};
#endif
...
static const short yydefact[] = {     2,
     0,     5,     0,    20,    19,     1,     3,     0,     8,    18,
    17,     0,     0,     9,    10,    14,     0,     0,    11,     4,
     0,     7,     0,    12,    15,    18,    16,     6,    13,     0,
     0,     0
};

static const short yydefgoto[] = {    30,
     1,     6,    12,    13,     7,    14,    15,    16,     8
};

static const short yypact[] = {-32768,
    -1,-32768,    13,-32768,-32768,-32768,-32768,     2,    -4,    10,
-32768,     0,     8,     5,-32768,-32768,    11,    17,    18,-32768,
    12,-32768,     6,-32768,-32768,-32768,     5,-32768,-32768,    25,
    26,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,-32768,    15,-32768,    14,-32768,     7,-32768
};
...
static const short yytable[] = {     2,
    19,   -15,    10,    11,    17,     3,   -11,    20,    26,    11,
    23,     4,     5,     9,    18,    10,    11,    25,    22,    26,
    11,    24,    28,   -15,    31,    32,    21,     0,     0,    29,
     0,    27
};

static const short yycheck[] = {     1,
     1,     6,     3,     4,     3,     7,    11,     8,     3,     4,
     6,    13,    14,     1,     5,     3,     4,     1,    11,     3,
     4,    11,    11,     6,     0,     0,    12,    -1,    -1,    23,
    -1,    18
};
...
#line 72 "lab07.y"
{ 
                if (lookupType(yyvsp[-1].tokname) == -1)
                   setType(yyvsp[-1].tokname,yyvsp[-2].tokid);
                else {
                  errcnt++;
                  fprintf(stdout,"%s declared twice, lineno %d\n",yyvsp[-1].tokname,yylineno);  
                }
            ;
    break;}
case 14:
...
#line 88 "lab07.y"
{ 
                if (lookupType(yyvsp[-2].tokname) == -1)  {
                   errcnt++;
...
case 18:
#line 98 "lab07.y"
{ yyval.tokid = t = lookupType(yyvsp[0].tokname); ;
    break;}
case 19:
#line 101 "lab07.y"
{ yyval.tokid = ITYPE; ;
