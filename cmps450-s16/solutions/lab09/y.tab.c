...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from lab09.y  */
...
const int YY_parser_CLASS::EQ=258;
const int YY_parser_CLASS::LE=259;
const int YY_parser_CLASS::IDENT=260;
const int YY_parser_CLASS::NUM=261;
const int YY_parser_CLASS::INT=262;
const int YY_parser_CLASS::IF=263;
const int YY_parser_CLASS::ELSE=264;
const int YY_parser_CLASS::RET=265;
const int YY_parser_CLASS::WHILE=266;
...
static const short yyprhs[] = {     0,
     0,     2,     5,    11,    15,    17,    21,    32,    35,    39,
    50,    54,    58,    62,    64,    66,    68,    69
};

static const short yyrhs[] = {    19,
     0,    29,    20,     0,     8,    27,    13,    14,    21,     0,
    15,    22,    16,     0,    23,     0,    22,    28,    23,     0,
     9,    13,    25,    14,    28,    23,    29,    10,    28,    23,
     0,    24,    17,     0,    11,     7,    17,     0,    12,    28,
    13,    25,    14,    28,    15,    22,    16,    29,     0,    27,
     3,    26,     0,    26,     4,    26,     0,    26,     5,    26,
     0,    27,     0,     7,     0,     6,     0,     0,     0
};
...
static const short yyrline[] = { 0,
    60,    71,    80,    88,    95,   101,   110,   119,   125,   134,
   145,   154,   168,   179,   185,   195,   202,   209
};

static const char * const yytname[] = {   "$","error","$illegal.","'='","EQ",
"LE","IDENT","NUM","INT","IF","ELSE","RET","WHILE","'('","')'","'{'","'}'","';'",
"head","prog","func","func_body","stmt_list","stmt","assign","cond","expr","id",
"mark","jump_mark",""
};
#endif
...
static const short yyr2[] = {     0,
     1,     2,     5,     3,     1,     3,    10,     2,     3,    10,
     3,     3,     3,     1,     1,     1,     0,     0
};

static const short yydefact[] = {    18,
     1,     0,     0,     2,    16,     0,     0,     0,     0,     3,
     0,     0,    17,    17,     5,     0,     0,     0,     0,     0,
     4,     0,     8,     0,    15,     0,     0,    14,     9,     0,
     6,    11,    17,     0,     0,     0,     0,    12,    13,    17,
    18,     0,     0,     0,    17,    17,     0,    18,     7,    10,
     0,     0,     0
};

static const short yydefgoto[] = {    51,
     1,     4,    10,    14,    15,    16,    26,    27,    17,    22,
     2
};

static const short yypact[] = {-32768,
-32768,    11,     2,-32768,-32768,     7,    10,     8,     0,-32768,
    12,    21,-32768,    14,-32768,    16,    32,    -2,    19,    24,
-32768,     0,-32768,    -2,-32768,    25,     9,-32768,-32768,    -2,
-32768,-32768,-32768,    -2,    -2,    26,     0,-32768,-32768,-32768,
-32768,    23,    31,     0,-32768,    27,     0,-32768,-32768,-32768,
    42,    44,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,-32768,     1,   -21,-32768,    17,   -17,    -3,   -11,
   -38
};
...
static const short yytable[] = {     6,
    31,    20,    43,     5,    25,     5,    32,     5,    11,    50,
    12,    13,    34,    35,    28,    41,    38,    39,     3,     7,
    28,    37,     9,     8,    18,    49,    28,    19,    42,    21,
    28,    28,    23,    47,    24,    29,    30,    44,    33,    40,
    45,    52,    48,    53,    46,     0,    36
};

static const short yycheck[] = {     3,
    22,    13,    41,     6,     7,     6,    24,     6,     9,    48,
    11,    12,     4,     5,    18,    37,    34,    35,     8,    13,
    24,    33,    15,    14,    13,    47,    30,     7,    40,    16,
    34,    35,    17,    45,     3,    17,    13,    15,    14,    14,
    10,     0,    16,     0,    44,    -1,    30
};
...
#line 72 "lab09.y"
{
         ...
         backpatch(yyvsp[0].stmt.nextList, nextlabel());
...
#line 81 "lab09.y"
{
        addFunc(yyvsp[-3].str, 0, funcLineno);
...
#line 102 "lab09.y"
{
         ...
         backpatch(yyvsp[-2].stmt.nextList,yyvsp[-1].mark.label);
         yyval.stmt.nextList = yyvsp[0].stmt.nextList;
...
#line 111 "lab09.y"
{
         ...
         backpatch(yyvsp[-7].expr.trueList,yyvsp[-5].mark.label);
         backpatch(yyvsp[-7].expr.falseList,yyvsp[-1].mark.label);
         yyval.stmt.nextList = listcat(yyvsp[-3].mark.nextList,yyvsp[0].stmt.nextList);
         yyval.stmt.nextList = listcat(yyval.stmt.nextList,yyvsp[-4].stmt.nextList);
...
#line 126 "lab09.y"
{
         ...
         yyval.stmt.nextList = NULL;
         sprintf(codeBuffer,"RETURN %s",yyvsp[-1].expr.value);
         gencode(codeBuffer);
...
#line 135 "lab09.y"
{
          ...
          backpatch(yyvsp[-6].expr.trueList,yyvsp[-4].mark.label);
          yyval.stmt.nextList = yyvsp[-6].expr.falseList;
          backpatch(yyvsp[-2].stmt.nextList,yyvsp[-8].mark.label);
          backpatch(yyvsp[0].mark.nextList,yyvsp[-8].mark.label);
...
#line 146 "lab09.y"
{
          ...
          sprintf(codeBuffer,"%s := %s",yyvsp[-2].str,yyvsp[0].expr.value);
          gencode(codeBuffer);
...
#line 155 "lab09.y"
{
          ...
          sprintf(codeBuffer,"IF (%s == %s) GOTO",yyvsp[-2].expr.value,yyvsp[0].expr.value);
          yyval.expr.trueList = addToList(NULL, gencode(codeBuffer));
          sprintf(codeBuffer,"GOTO");
          yyval.expr.falseList = addToList(NULL, gencode(codeBuffer));
          yyval.expr.trueList = listcat(yyval.expr.trueList, yyvsp[-2].expr.trueList);
          yyval.expr.falseList = listcat(yyval.expr.falseList, yyvsp[-2].expr.falseList);
          yyval.expr.trueList = listcat(yyval.expr.trueList, yyvsp[0].expr.trueList);
          yyval.expr.falseList = listcat(yyval.expr.falseList, yyvsp[0].expr.falseList);
          yyval.expr.value = "TrueFalse";
...
#line 210 "lab09.y"
{
       ...
       yyval.mark.label= nextlabel();
       sprintf(codeBuffer,"GOTO");
       yyval.mark.nextList = addToList(NULL, gencode(codeBuffer));
