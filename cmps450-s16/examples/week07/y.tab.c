...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from grammarG.y  */
...
const int YY_parser_CLASS::PLUS=259;
const int YY_parser_CLASS::TIMES=260;
const int YY_parser_CLASS::LPAREN=261;
const int YY_parser_CLASS::RPAREN=262;
const int YY_parser_CLASS::ERROR=263;
...
static const char * const yytname[] = {   "$","error","$illegal.","IDENT","PLUS",
"TIMES","LPAREN","RPAREN","ERROR","expr","term","factor",""
};
#endif
...
-32768,    -1,     0,    -4,-32768,     2,    -1,    -1,-32768,    -4,
-32768,     3,-32768
};
