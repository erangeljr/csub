...
const int YY_parse_CLASS::OP=258;
const int YY_parse_CLASS::ASSIGN=259;
const int YY_parse_CLASS::NAME=260;
...
static const char * const yytname[] = {   "$","error","$illegal.","OP","ASSIGN",
"NAME","NUMBER","equation","expression",""
};
#endif
...
#line 32 "sample.y"
{  
                                    printf("(NAME)%s",yyvsp[-2].str_val);  
                                    printf("(ASSIGN)%c",yyvsp[-1].op_val);  
                                    return 0;
                                 ;
    break;}
case 2:
#line 38 "sample.y"
{ printf("(NUMBER)%d",yyvsp[0].int_val); ;
    break;}
case 3:
#line 39 "sample.y"
{ printf("(NUMBER)%d",yyvsp[-1].int_val); ;
    break;}
}
