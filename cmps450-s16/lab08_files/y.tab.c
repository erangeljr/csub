...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from lab08.y  */
...
const int YY_parser_CLASS::A=258;
const int YY_parser_CLASS::B=259;
const int YY_parser_CLASS::C=260;
const int YY_parser_CLASS::LPAR=261;
const int YY_parser_CLASS::RPAR=262;
const int YY_parser_CLASS::PLUS=263;
const int YY_parser_CLASS::MINUS=264;
const int YY_parser_CLASS::MULT=265;
const int YY_parser_CLASS::DIV=266;
const int YY_parser_CLASS::NL=267;
...
static const short yyprhs[] = {     0,
     0,     1,     5,     7,     9,    13,    17,    19,    23,    27,
    29,    33,    36,    38,    40
};

static const short yyrhs[] = {    -1,
    13,    14,    12,     0,    15,     0,    16,     0,    15,     9,
    16,     0,    15,     8,    16,     0,    17,     0,    16,    10,
    17,     0,    16,    11,    17,     0,    18,     0,     6,    15,
     7,     0,     9,    17,     0,     3,     0,     4,     0,     5,
     0
};
...
static const short yyrline[] = { 0,
    28,    29,    32,    34,    41,    50,    60,    67,    72,    79,
    87,    94,   103,   103,   103
};

static const char * const yytname[] = {   "$","error","$illegal.","A","B","C",
"LPAR","RPAR","PLUS","MINUS","MULT","DIV","NL","list","stmt","expr","term","fact",
"id",""
};
#endif

static const short yyr1[] = {     0,
    13,    13,    14,    15,    15,    15,    16,    16,    16,    17,
    17,    17,    18,    18,    18
};
...
static const short yydefact[] = {     1,
     0,    13,    14,    15,     0,     0,     0,     3,     4,     7,
    10,     0,    12,     2,     0,     0,     0,     0,    11,     6,
     5,     8,     9,     0,     0
};
...
static const short yypact[] = {-32768,
     1,-32768,-32768,-32768,    10,    10,    11,     0,    -8,-32768,
-32768,    13,-32768,-32768,    10,    10,    10,    10,-32768,    -8,
    -8,-32768,-32768,    24,-32768
};
...
static const short yytable[] = {    13,
    24,    17,    18,     2,     3,     4,     5,    15,    16,     6,
    22,    23,     2,     3,     4,     5,    20,    21,     6,    19,
    15,    16,    14,    25,    12
};

static const short yycheck[] = {     6,
     0,    10,    11,     3,     4,     5,     6,     8,     9,     9,
    17,    18,     3,     4,     5,     6,    15,    16,     9,     7,
     8,     9,    12,     0,     5
};
...
case 3:
#line 32 "lab08.y"
{ printf("%s\n\n", yyvsp[0].s); free(yyvsp[0].s); yyvsp[0].s = NULL;;
    break;}
case 4:
#line 35 "lab08.y"
{ 
        yyval.s = (char*)malloc(sizeof(char) * 1024);
...
{ 
        yyval.s = (char*)malloc(sizeof(char) * 1024);
        sprintf(yyval.s, "minus(%s,%s)", yyvsp[-2].s, yyvsp[0].s); 
        free (yyvsp[-2].s);
        free (yyvsp[0].s);
        yyvsp[-2].s = NULL;
        yyvsp[0].s = NULL;
...
{ 
        yyval.s = (char*)malloc(sizeof(char) * 1024);
        sprintf(yyval.s, "plus(%s,%s)", yyvsp[-2].s, yyvsp[0].s); 
        free (yyvsp[-2].s);
        free (yyvsp[0].s);
        yyvsp[-2].s = NULL;
        yyvsp[0].s = NULL;
...
{ 
        yyval.s = (char*)malloc(sizeof(char) * 1024);
        sprintf(yyval.s, "times(%s,%s)", yyvsp[-2].s, yyvsp[0].s); 
        ;
    break;}
case 9:
#line 73 "lab08.y"
{
        yyval.s = (char*)malloc(sizeof(char) * 1024);
        sprintf(yyval.s, "divides(%s,%s)", yyvsp[-2].s, yyvsp[0].s);
        ;
    break;}
case 10:
#line 80 "lab08.y"
...
{
        yyval.s = (char*)malloc(sizeof(char) * 1024);
        sprintf(yyval.s, "negative(%s)", yyvsp[0].s);
        free (yyvsp[0].s);
        yyvsp[0].s = NULL;
        ;
    break;}
